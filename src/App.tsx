...
import BeeepStagingPageV2 from "./pages/BeeepStagingPageV2";
        ...
        <HelmetProvider>
          <TooltipProvider>
            ...
            <BrowserRouter>
              <Routes>
                {/* Primary homepage */}
                <Route path="/" element={<BeeepStagingPage />} />
                ...
                {/* V2 Experimental Page */}
                <Route path="/v2" element={<BeeepStagingPageV2 />} />
