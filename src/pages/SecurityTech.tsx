  ...
  const stackCards = [
    ...
    },
    {
      ...
      body: [
        ...
        "Unlike AI-based brushstroke analysis used to evaluate artistic authorship, surface-based authentication technologies verify the physical identity of an object itself—making them suitable for ongoing provenance and lifecycle engagement rather than one-time attribution.",
      ],
    },
    {
