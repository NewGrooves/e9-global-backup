...
const TheTeam = () => {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      name: "Sam Morris",
      role: "Founder, CEO",
      description: "Paralysis survivor and highly regarded leadership mentor empowering E9 Global with embodied insight to reimagine commerce through authenticity, resilience, and purpose-driven impact.",
