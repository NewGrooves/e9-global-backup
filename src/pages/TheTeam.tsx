...
const TheTeam = () => {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      // IMPORTANT: This uses URL-encoded spaces to avoid runtime/hosting issues.
    ...
    },
    {
      ...
      role: "Strategic Advisor",
      description:
        "Seasoned healthcare entrepreneur with 30 years' expertise scaling, operating, and exiting companies across multiple healthcare verticals.",
    ...
    },
    {
      ...
      role: "Strategic Advisor",
      description:
        "UCLA Anderson's top-rated executive leadership professor and a globally respected executive coach to senior leaders worldwide.",
    ...
    },
    {
      ...
      role: "Strategic Advisor",
      description:
        "Founder and Managing Director of Advance Ventures. A Silicon Valley venture investor with a 25-year track record of high-growth startups, exits, and innovation.",
    ...
    },
    {
      ...
      role: "Legal Advisor",
      description:
        "Veteran technology, privacy, and corporate lawyer guiding enterprises with strategic, ethical, and future-focused legal expertise for over three decades.",
            ...
            {teamMembers.map((member) => (
              ...
              >
                <div className="relative z-10">
                  ...
                  {/* Name */}
                  <h3 className="text-2xl font-playfair font-bold mb-3 text-foreground">{member.name}</h3>
