    ...
    <section className="py-20 bg-secondary relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-playfair font-bold gradient-text-investor mb-6 py-2" style={{ lineHeight: '1.3' }}>
            Packaging Was Silent for 100 Years.<br />
      ...
      {/* Large Background Decoration - remove one, change shape */}
      <div className="absolute -bottom-40 -left-40 w-72 h-72 bg-white/3 rounded-3xl transform rotate-45"></div>
    </section>
  );
};
